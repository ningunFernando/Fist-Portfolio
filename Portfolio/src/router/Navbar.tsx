...
const Navbar = () => {
  ...
  return (
    <div className=' nav font-mono flex flex-row space gap-4 space text-2xl place-content-between border  
    border-b-black sticky top-0'>
        <Link to={"/home"}>
        <div className='logo flex fle-row p-9'>
          ...
          <div className='bg-black text-5xl mr-10 z-20 md:hidden h-12 w-12'>
            <img src="" alt="" />
          </div>
        

        <div className='xs:hidden md:flex hidden flex-row gap-10 '>
            {links.map( item => {
                return(
